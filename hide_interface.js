    ...
    function startPlugin() {
        ...
        function createMenuSettings() {
            ...
            if (!leftSettingsCreated) {
                ...
                // Настройки для левого меню с TV-поддержкой
                ...
                $('.menu__item').each(function() {
                    ...
                    Lampa.SettingsApi.addParam({
                        ...
                        onRender: function(item) {
                            ...
                            // Для TV используем изменение параметра
                            item.data('toggleItem', toggleItem);
                            
                            // Для TV добавляем обработчик клавиш
                        ...
                        onChange: function(data) {
                            if (Lampa.Platform.is('tv')) {
                                var toggleFunc = data.item.data('toggleItem');
            ...
            if (!headSettingsCreated) {
                ...
                // Настройки для верхнего меню с TV-поддержкой
            ...
            if (!settingsSettingsCreated) {
                ...
                // Настройки для правого меню (Настройки) с TV-поддержкой
